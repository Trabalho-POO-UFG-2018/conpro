...
public class ProdutoDAO {
	...
	public static void cadastrarProduto(Loja loja, Produto produto){
		...
		try {
			...
			sql = "insert into loja_produto (nome_produto,id_loja, id_produto, qtde, preco) values (?,?, ?, ?, ?)";
			stmt = con.prepareStatement(sql);
	...
	public static ArrayList<Produto> obterProdutos(String nome) {
		...
		try {
			stmt = con.prepareStatement("SELECT * FROM loja_produto WHERE nome_produto = ?");
